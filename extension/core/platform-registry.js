...
class PlatformRegistry {
  ...
  register(platformInstance) {
    ...
    wenliuEventBus.emit('platform:registered', { id, instance: platformInstance });
  }
  ...
  unregister(id) {
    ...
    wenliuEventBus.emit('platform:unregistered', { id });
...
// 全局平台注册中心实例
window.wenliuPlatformRegistry = new PlatformRegistry();